...
if(isset($_POST['materia'])) { //Si se selelcciona una materia
    $grupos = consultagrupos(); //Consulta para obtener los grupos de la materia seleccionada del profesor
}
else $grupos = null; //Si no se selecciona una materia, no se muestran los grupos


if(isset($_POST['grupo'])) { //Si se selecciona un grupo
    $alumnos = consultaralumnos(); //Consulta para obtener los alumnos del grupo seleccionado
}
...
<body>
    ...
    <div class="contenedor">
            ...
            <div class="titulo">
                ...
                <?php if($alumnos): ?> <!--Si se selecciona un grupo, mostramos los alumnos-->
